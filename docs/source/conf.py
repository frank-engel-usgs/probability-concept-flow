...
from probconcept import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "probability-concept-flow"
# copyright = f"{datetime.today().year}, CC 4.0"
...
html_title = f"probconcept v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/frank-engel-usgs/probability-concept-flow",
            "html": """
